/*
 * This code takes resistor color bands and returns a completed value
 * Modified by Jeff Thompson  
 *
 * Based on Resistor Helper, by Connor A. Huffine. See his project at:
 * https://www.hackster.io/kontakr/resistor-helper-aa740c
 */
...
exports.handler = function (event, context) {
    try {
        ...
        if (event.session.application.applicationId !== "amzn1.ask.skill.b044f90d-3d1b-4427-b251-fc07061b5895") {
...
function onSessionStarted(sessionStartedRequest, session) {
    console.log("onSessionStarted requestId=" + sessionStartedRequest.requestId +
        ...
        //This is a test block unrelated to the resistor decoder--Jeff
...
function onIntent(intentRequest, session, callback) {
    ...
    if ("BandsToValue" === intentName) {
        BandsToValue(intent, session, callback);
    } else if ("ValueToBand" === intentName) {
        ValueToBand(intent, session, callback);
...
function BandsToValue(intent, session, callback) {
    var value = 0;
    var tolerance;
